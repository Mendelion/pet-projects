...
def click(): #новое окно после того как нажмём начать игру
    ...
    #КОЛЯ!!! Какие окна, я ничего не понимаю аааааааааааааааааааааааа
    #Олсо когда закрываешь окно, процесс не завершается... Так должно быть? Должен быть какой-нибудь exit 0 мб
    #Соррян, что не пишу никакой код, я очень устал и хочу спать((
